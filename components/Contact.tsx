      ...
      <div style={{ maxWidth: "780px", margin: "0 auto" }}>
        ...
        {submitted ? (
          <div style={{ textAlign: "center", padding: "2rem 0" }}>
            <p style={{ fontFamily: "Georgia, serif", color: "#555" }}>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div style={{ marginBottom: "1.25rem" }}>
              ...
              />
              {errors.name && (
                <p style={{ color: "#cc3333", fontSize: "0.75rem", marginTop: "0.25rem", fontFamily: "Georgia, serif" }}>
                  {errors.name}
                </p>
              )}
            </div>
            ...
            >
              ...
              <span style={{ fontFamily: "Georgia, serif", fontSize: "0.875rem", color: "#888888" }}>
                Attachments ({form.file ? 1 : 0})
              </span>
            </div>
            ...
            >
              ...
              <a href="#privacy" style={{ color: "#4a9ea1", textDecoration: "none" }}>Privacy Policy</a>
              {" "}and{" "}
              <a href="#terms" style={{ color: "#4a9ea1", textDecoration: "none" }}>Terms of Service</a>
              {" "}apply.
            </p>
          </form>
        )}
        ...
        <div style={{ textAlign: "center", margin: "3rem 0 2.5rem" }}>
          ...
          >
            We know that our clients have unique needs. Send us a message, and we will get back to
            you soon.
          </p>
        </div>

        {/* Two-column info: Address | Hours */}
        <div
          style={{
            display: "grid",
        ...
        >
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ fontFamily: "Georgia, serif", fontSize: "0.875rem", color: "#555555", marginTop: "0.75rem" }}>
              +91.7893059116
            </p>
          </div>
